...
import org.usfirst.frc.team2220.robot.commands.DriveForTime;
import org.usfirst.frc.team2220.robot.commands.ExampleCommand;
import org.usfirst.frc.team2220.robot.subsystems.Climber;
import org.usfirst.frc.team2220.robot.subsystems.DriveTrain;
...
public class Robot extends IterativeRobot {
	...
	public void autonomousPeriodic() {
		...
		if (autoTimer.get() < 3) {
			...
			driveTrain.lDriveMaster.set(-0.4);
			driveTrain.rDriveMaster.set(0.4);
	...
	public void teleopPeriodic() {
		...
		SmartDashboard.putNumber("Outside Talon 1", climber.climberMaster.getTemperature());
		SmartDashboard.putNumber("Outside Talon 2", climber.climberSlave.getTemperature());
